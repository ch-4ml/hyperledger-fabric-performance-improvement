...
const setPlantsConfigFile = path.resolve(__dirname, 'v1_WorldState_Set100Plants.json');
...
async function main() {
    ...
    try {
        ...
        for (let counter = nextPlantNumber - 100; counter < nextPlantNumber; counter++) {
            ...
            await contract.submitTransaction('transferPlant', docType+counter, owners[randomOwner]);
            console.log("Update a plant: " + docType + counter + "   new owner:"  + owners[randomOwner]);
        }
